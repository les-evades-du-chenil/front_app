...
class HelloGrpcClient extends $grpc.Client {
  ...
  HelloGrpcClient($grpc.ClientChannel channel,
...
abstract class HelloGrpcServiceBase extends $grpc.Service {
  $core.String get $name => 'hello.HelloGrpc';

  HelloGrpcServiceBase() {
